...
public class Scraper implements IScraper {
     ...
     * @return Returns an Item if it can be found in the document. Returns null if the document is empty
     * or the item can't be found.
     */
    @Override
